...
Revision ID: 2e2b6a5978d6
Revises: da8f32b485e6
Create Date: 2026-09-15 18:58:26.422288
...
revision: str = '2e2b6a5978d6'
down_revision: Union[str, Sequence[str], None] = 'da8f32b485e6'
...
def upgrade() -> None:
    ...
    op.create_index('ix_conversations_profile_updated_at', 'conversations', ['profile_id', 'updated_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_conversations_profile_updated_at', table_name='conversations')
